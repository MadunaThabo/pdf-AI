...
def get_conversation_chain(vectorstore):
    ...
    model_name = "./pretrainedModels/flan-t5-small"
    llm = HuggingFacePipeline.from_model_id(model_id= model_name, task="text2text-generation", model_kwargs={"temperature": 0.1, "max_length": 1000, "do_sample": True})
